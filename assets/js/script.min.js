$(document).ready(function(){
    ...
    $(window).scroll(function(){var o=$(window).height(),n=$(window).scrollTop();$(".animated2").each(function(){var i=$(this).offset().top;n+o>=i&&($(this).addClass("fadein"))})})});//宣告預設表單內容為空 （你想要的話也可以加東西）
var initSubject='',initBody='';

//按下傳送按鈕後執行
function submitHandler(){
    var to = "glen90803@gmail.com";//寫死的傳送對象 就是公司的信箱 不會顯示在網頁上
